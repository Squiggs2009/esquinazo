...
export const formatMatchTime = (iso) => matchTimeFormatter.format(new Date(iso));
/**
 ...
 */
export function matchTimeParts(iso) {
...
export const matchDay = (iso) => dayFormatter.format(new Date(iso));
export const articleDate = (iso) => articleFormatter.format(new Date(iso));
...
export function groupByDay(fixtures) {
    ...
    for (const fixture of [...fixtures].sort((a, b) => a.fixture.date.localeCompare(b.fixture.date))) {

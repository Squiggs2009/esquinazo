...
const en = {
    ...
    "home.tagline": "Scores, tables, squads. No ads, no logins, no nonsense — just what happened and who's next.",
    ...
    "home.noneToday": "No matches scheduled today. The season never really stops — check the fixture list.",
    ...
    "fixtures.lede": "One week at a time - scheduled and completed matches in the selected competition.",
    ...
    "fixtures.emptyDetail": "Nothing scheduled for {league} during {range}. Try the next or previous week - mid-season breaks and international windows leave gaps like this.",
    /* Standings */
    "standings.eyebrow": "Table",
    "standings.title": "Standings",
    "standings.lede": "Position, record and recent form. Green marks the continental places, red the drop.",
    "standings.emptyTitle": "No table yet",
    "standings.emptyDetail": "Standings appear once the competition has played its opening round. Cup formats may not produce one at all.",
    "standings.club": "Club",
    "standings.played": "Pl",
    "standings.won": "W",
    "standings.drawn": "D",
    ...
    "players.noMatchDetail": "Nothing in this squad matches “{search}”. Try a surname, or a position like \"Midfielder\".",
    ...
    "player.modal.statsEmpty": "The squad list this page uses doesn't include per-player season statistics yet.",
    ...
    "position.legendNote": "The data provider reports these four categories only, so squads are grouped by them rather than by finer roles like centre back or winger.",
    ...
    "news.notWiredDetail": "The news feed has not shipped. Everything else on the site runs on live data — fixtures and tables update every minute.",
    "news.emptyTitle": "Nothing published",
    "news.emptyDetail": "No stories have come through the feed today. Try the fixtures page for what is actually happening.",
    ...
    "wire.emptyDetail": "Everything published so far already fits on the front page. Check back once there is more behind it.",
    /* Match detail */
    "match.title": "Match",
    "match.backToFixtures": "← Fixtures",
    "match.notFoundTitle": "Match not found",
    "match.notFoundDetail": "This fixture is not in the current feed window. Completed matches drop out of the list once the round moves on.",
    ...
    "match.timelineEmpty": "No events yet. Goals, cards and substitutions appear here as the match runs.",
    ...
    "nations.lede": "The 48 national teams at the 2026 World Cup, with their groups and squads.",
    "nations.group": "Group",
    "nations.ungrouped": "Group to be drawn",
    "nations.selectNation": "Nation",
    "nations.squad": "Squad",
    "nations.squadEmptyTitle": "Squad not published",
    "nations.squadEmptyDetail": "This national team has no squad list in the feed yet. Squads firm up close to the tournament.",
    "nations.clubNote": "Club affiliation is not published for national-team squads, so only shirt number, age and position are shown.",
    ...
    "state.upstreamDetail": "Our provider is not responding. Cached results are shown where we have them.",
    "state.genericTitle": "Could not load",
    "state.genericDetail": "Something went wrong on the way to the server.",
    /* Footer */
    "footer.blurb": "Live scores, tables and squads across football's major leagues. No accounts, no tracking, no interstitials.",
...
const es = {
    ...
    "home.tagline": "Resultados, tablas, plantillas. Sin anuncios, sin cuentas, sin rodeos — solo lo que pasó y lo que viene.",
    ...
    "home.noneToday": "No hay partidos programados hoy. La temporada nunca se detiene del todo — consulta el calendario.",
    ...
    "fixtures.lede": "Una semana a la vez: partidos programados y disputados de la competición seleccionada.",
    ...
    "fixtures.emptyDetail": "No hay nada programado para {league} durante {range}. Prueba la semana siguiente o anterior: los parones y las fechas FIFA dejan huecos así.",
    "standings.eyebrow": "Tabla",
    "standings.title": "Clasificación",
    "standings.lede": "Posición, registro y forma reciente. El verde marca los puestos continentales; el rojo, el descenso.",
    "standings.emptyTitle": "Todavía sin tabla",
    "standings.emptyDetail": "La clasificación aparece cuando la competición ha jugado su primera jornada. Los formatos de copa pueden no generarla.",
    "standings.club": "Club",
    "standings.played": "PJ",
    "standings.won": "G",
    "standings.drawn": "E",
    ...
    "players.lede": "Elige una liga y un club, luego filtra por nombre, posición o dorsal.",
    ...
    "players.noMatchDetail": "Nada en esta plantilla coincide con “{search}”. Prueba con un apellido o una posición como \"Centrocampista\".",
    ...
    "player.modal.statsEmpty": "La plantilla que usa esta página todavía no incluye estadísticas individuales por temporada.",
    ...
    "position.legendNote": "El proveedor de datos informa solo estas cuatro categorías, así que las plantillas se agrupan por ellas y no por funciones más específicas como central o extremo.",
    "position.descGoalkeeper": "Defiende la portería. Viste distinto y es el único que puede tocar el balón con las manos en juego.",
    "position.descDefender": "Juega atrás: centrales y laterales por igual.",
    "position.descMidfielder": "Une defensa y ataque, desde funciones de contención hasta de creación.",
    ...
    "news.notWiredDetail": "El servicio de noticias aún no está publicado. Todo lo demás funciona con datos en vivo: partidos y tablas se actualizan cada minuto.",
    "news.emptyTitle": "Nada publicado",
    "news.emptyDetail": "Hoy no han llegado noticias. Prueba la página de partidos para ver lo que está pasando.",
    "wire.archiveEyebrow": "The Wire",
    ...
    "wire.emptyDetail": "Todo lo publicado hasta ahora cabe en la portada. Vuelve cuando haya más detrás.",
    "match.title": "Partido",
    "match.backToFixtures": "← Partidos",
    "match.notFoundTitle": "Partido no encontrado",
    "match.notFoundDetail": "Este partido no está en la ventana actual de datos. Los partidos disputados salen de la lista cuando avanza la jornada.",
    ...
    "match.timelineEmpty": "Todavía sin incidencias. Goles, tarjetas y cambios aparecerán aquí durante el partido.",
    ...
    "nations.lede": "Las 48 selecciones del Mundial 2026, con sus grupos y plantillas.",
    "nations.group": "Grupo",
    ...
    "nations.squadEmptyDetail": "Esta selección todavía no tiene lista de convocados. Las plantillas se concretan cerca del torneo.",
    "nations.clubNote": "El club no se publica para las plantillas de selecciones, así que solo se muestran dorsal, edad y posición.",
    ...
    "state.upstreamDetail": "Nuestro proveedor no responde. Se muestran resultados en caché cuando los hay.",
    "state.genericTitle": "No se pudo cargar",
    "state.genericDetail": "Algo salió mal camino del servidor.",
    "footer.blurb": "Resultados en vivo, tablas y plantillas de las grandes ligas del fútbol. Sin cuentas, sin rastreo, sin interrupciones.",
...
export function statusTranslationKey(short) {
...
export function isKnownPosition(value) {
    return POSITION_ORDER.includes(value);
}
